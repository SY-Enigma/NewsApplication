...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView img_main, img_seting, img_mine,img_video;
    private TextView text_main, text_setting, text_mine,text_video;
    ...
    private void initView() {
        ...
        ll_video = (LinearLayout)findViewById(R.id.layout_video);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_video: {
                ...
                img_video.setImageResource(R.drawable.video_choose);
                img_seting.setImageResource(R.drawable.setting);
                img_mine.setImageResource(R.drawable.mine);
            }
            break;
